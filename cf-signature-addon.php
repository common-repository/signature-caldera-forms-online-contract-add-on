 ...
 * Define constants
 */
define( 'CF_WPESIGNATURE_VER', '1.5.7.5' );
...
require_once( plugin_dir_path( __FILE__ ) . 'admin/esig-caldera-filters.php' );
...
//if (is_admin()) {
	...
	require_once( plugin_dir_path( __FILE__ ) . 'admin/esig-cfds-admin.php' );
        ...
        add_action( 'plugins_loaded', array( 'esigCalderaFilters', 'instance' ) );
