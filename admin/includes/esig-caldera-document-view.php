        	   ...
        	   $more_option_page = ''; 
        	    ...
        	    $more_option_page .= '<div id="esig-caldera-option" class="esign-form-panel" style="display:none;">
                 ...
                 $more_option_page .='<!-- Caldera form second step start here -->
                                        	...
                                        	<div align="center" class="esig-popup-header esign-form-header">'.__('What caldera form field data would you like to insert?', 'esig').'</div>
                                            ...
                                            <p id="esig-cf-field-option" align="center">
                                             ...
                                             <p id="select-caldera-field-display-type" align="center">
                                	    
                        		        <select data-placeholder="Choose a Option..." class="chosen-select" tabindex="2" id="esig-caldera-form-id" name="esig_caldera_value_display_type">
