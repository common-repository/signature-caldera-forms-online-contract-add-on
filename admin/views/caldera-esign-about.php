...
<!--[if lt IE 9]><script>document.createElement('audio');document.createElement('video');</script><![endif]-->
        <div class="wrap approveme-about-wrap">
            ...
            <h1>Get Started with Caldera Forms &amp; WPESign by ApproveMe</h1>
            ...
            <div class="about-text top">Automatically collect digital signatures on contracts, after your visitors submit a form using ApproveMe's WP E-Signature. 
                Collect <a href="https://www.approveme.com/ueta-and-esign-act/?utm_source=wprepo&utm_medium=link&utm_campaign=calderaforms
                           ">UETA/ESIGN Compliant</a>  legally binding contracts with WordPress.

                <br>
            </div>

            <div align="center"> <div class="approveme-demo-btn"><a class="approveme-demo-link"  href="http://www.secure.approveme.com/demo/?utm_source=wprepo&utm_medium=link&utm_campaign=calderaforms">Try a Live Demo of this Integration</a></div></div>
            ...
            <div id="esig-yt-video">
                <p align="center">
                    ...
                    <a href="//www.youtube.com/embed/3zcl261CzOQ?&autoplay=1&rel=0&theme=light&hd=1&autohide=1&showinfo=0&color=white&showinfo=0?TB_iframe=true&width=960&height=540" class="thickbox">
            ...
            <div class="approveme-cta">
                <a href="https://www.approveme.com/?utm_source=wprepo&utm_medium=link&utm_campaign=calderaforms" class="hvr-float-shadow">Get My ApproveMe Plugin</a>
            </div>
            ...
            <div class="changelog feature-list">
                ...
                <div class="approveme-feature-section approveme-table">
                    <div class="approveme-row">
                        <div class="approveme-column-2">
                            ...
                            <p><a href="https://wordpress.org/plugins/caldera-forms/" target="_blank">1. Caldera Forms</a><br> <a href="https://www.approveme.com/?utm_source=wprepo&utm_medium=link&utm_campaign=calderaforms">2. WP E-Signature</a> <em>(ultimate, business or professional license)<br> </em><a href="https://www.approveme.com/?utm_source=wprepo&utm_medium=link&utm_campaign=calderaforms">3. E-Signature Business Pack</a> <em>(included with the license above)<br> </em></p>
                        </div>

                        <div class="approveme-column-2 approveme-center">
                            <div class="approveme-image">
                                <p><br> <img src="<?php echo plugins_url('../assets/images/cf-add-on-step-1.png', __FILE__); ?>" class="esig-caldera-pic-border" width="100%">
                ...
                <div class="approveme-feature-section approveme-table">
                    <div class="approveme-row">
                        ...
                        <div class="approveme-column-2">
                            ...
                            <p>Once you have purchased a ultimate, business or professional license from ApproveMe you will need to <a href="admin.php?page=esign-licenses-general">enter your license key</a> to activate updates and support.</p>

                            <p>To download your license key you can log into your <a href="https://www.approveme.com/purchase-history/?utm_source=wprepo&utm_medium=link&utm_campaign=calderaforms">ApproveMe account here</a> (password was emailed with your receipt)</p>
                ...
                <div class="approveme-feature-section approveme-table">
                    <div class="approveme-row">
                        <div class="approveme-column-2">
                            ...
                            <div class="approveme-btn">    <p class="approveme-mini-btn"><a href="post-new.php?post_type=page" class="approveme-mini-btn" target="_blank">Create a Blank Page Now</a></p></div>

                            <p>To learn about Stand Alone Documents you can visit this <a href="https://www.approveme.com/wp-digital-signature-plugin-docs/faq/basic-document-vs-stand-alone-document/?utm_source=wprepo&utm_medium=link&utm_campaign=calderaforms" target="_blank">helpful article</a></p>
                        </div>

                        <div class="approveme-column-2 approveme-center">
                            <div class="approveme-image">
                                <p><br> <img src="<?php echo plugins_url('../assets/images/cf-add-on-step-3.png', __FILE__); ?>" class="esig-caldera-pic-border" width="100%">
                ...
                <div class="approveme-feature-section approveme-table">
                    <div class="approveme-row">
                        ...
                        <div class="approveme-column-2">
                            ...
                            <p>To learn more about Stand Alone Documents checkout the <a href="https://www.approveme.com/wp-digital-signature-plugin-docs/article/stand-alone-documents-add-on/?utm_source=wprepo&utm_medium=link&utm_campaign=calderaforms">documentation page</a> for this add-on.</p>
                ...
                <div class="approveme-feature-section approveme-table">
                    <div class="approveme-row">
                        <div class="approveme-column-2">
                            ...
                            <p>This step will vary based on your desired outcome.  A custom contract by Approve Me is triggered when a Caldera Form is submitted. This plugin gives you the ability to integrate Caldera Forms user data (that was inputted from the user when the form was submitted) into a NEW contract that will either be emailed to the user or will be displayed to the user immediately after they submit your form.</p>


                            <p><strong>How to add form fields data into a contract using Caldera Forms</strong><br><ol><li>Navigate to the Signer Input Fields/Custom Fields icon and select "Caldera Forms Data".</li>


                                <li>Select the Caldera Forms that you have already created (and would like to connect to your contract) using the dropdown menu.</li><li>Choose the field data that you would like to insert into your new contract.</li></ol></p>
                ...
                <div class="approveme-feature-section approveme-table">
                    <div class="approveme-row">
                        <div class="approveme-column-2">
                            ...
                            <p>Once you've published your Stand Alone Document you are 50% complete.  The next step is you will need to choose your "trigger" and "action" options for this document in Caldera Forms.</p>
                            ...
                            <p>Click <strong style="color: #fff;
                                             ...
                                             font-weight: 400;">Let's Go Now!</strong> to define those last Caldera Forms settings.</p>
                        </div>
                ...
                <div class="approveme-feature-section approveme-table">
                    <div class="approveme-row">
                        ...
                        <div class="approveme-column-2">
                            <h4><span class="esig-step">7</span> Finish setting up the Caldera Forms workflow/trigger</h4>
                            ...
                            <p>Navigate to the "Caldera Forms" + "Forms" tab found in the WordPress dashboard.</p>
                            <p>Click "Edit" on the form that you attached the Stand Alone Document.</p>
                            <p>Select the "Processors" tab.  Click "Add Processor" and then choose the "WP E-Signature by ApproveMe" option.</p>
                            <p>Pre-fill the signers name and email from the form fields.  And choose "Save Form."
                            <p>That's it!</p>
                            ...
                            <br>
                            <div align="center"> <div class="approveme-btn"><a class="approveme-demo-link" href="http://www.secure.approveme.com/demo/?utm_source=wprepo&utm_medium=link&utm_campaign=calderaforms">Try a Live Demo of this Integration</a></div></div>
                        </div>
                    </div>
                </div>
                <!-- End Step 4 -->
                ...
                <h2>Still got questions? Login to your account at <br> <a href="https://www.approveme.com/?utm_source=wprepo&utm_medium=link&utm_campaign=calderaforms
                                                                          ">www.approveme.com</a></h2>
            </div>
        </div>
