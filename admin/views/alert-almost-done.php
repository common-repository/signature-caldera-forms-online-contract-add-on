<div id="esig-caldera-almost-done" style="display: none;"> 
		   ...
		   <h3><?php _e('Almost there... you\'re 50% complete','esig-caldera'); ?></h3>
          ...
          head over to the "Form Settings" tab for the Caldera Form  you are trying to connect it to.' ,'esig-caldera'); ?> </p>
		</div>
        ...
        <div class="esig-updater-button">
		  ...
		  <span> <a href="#" class="button esig-secondary-btn"  id="esig-caldera-setting-later"> <?php _e('I\'LL DO THIS LATER','esig-caldera');?> </a></span>
                  <span> <a href="admin.php?page=caldera-forms&edit=<?php echo $data['form_id']; ?>" class="button esig-dgr-btn" id="esig-cf-lets-go"> <?php _e('LET\'S GO NOW!','esig-caldera');?> </a></span>
