...
$steps = esig_load_template(__DIR__ . '/caldera-esign-about-steps');

$about_options = array(
    'pluginName'        => 'Caldera Forms',
    'setupVidImage'     => plugins_url('../assets/images/getting-started-video-thumb.jpg', __FILE__),
    'setupVidURL'       => 'https://www.youtube.com/embed/3zcl261CzOQ?&autoplay=1&rel=0&theme=light&hd=1&autohide=1&showinfo=0&color=white&showinfo=0?TB_iframe=true&width=700&height=540',
    'stepContent'       => $steps
);
